...
const SOURCE_DIR =
	...
	path.join(
		__dirname,
		"../141ad165-1f76-4ac6-8dae-cffde7141cd4_ExportBlock-271e5df9-1459-4cf5-856e-9b6fd82a571e/ExportBlock-271e5df9-1459-4cf5-856e-9b6fd82a571e-Part-1/日记汇总",
	);
...
function extractDateFromFilename(filename) {
	...
	if (match) {
		const year = Number.parseInt(match[1], 10) + 2000; // 假设都是 2000 年后
 ...
 * 生成新的文件名（使用日期）
 */
function generateNewFilename(date, type, _originalName) {
	// 使用日期和类型生成文件名
