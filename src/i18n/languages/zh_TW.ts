...
export const zh_TW: Translation = {
	anime: "追番列表",
	animeSubtitle: "用來記錄我的追番記錄噠！",
	animeTitle: "追番列表",
	animeStatusAll: "全部",
	animeStatusDoing: "在看",
	animeStatusDone: "看過",
	animeStatusWish: "想看",
	animeStatusOnhold: "擱置",
	animeStatusDropped: "拋棄",
	animeList: "番劇列表",
	animeLoading: "加載中...",
	animeLoadingDescription: "正在從Bangumi獲取數據，請稍候...",
	animeError: "加載失敗",
	animeErrorDescription: "獲取數據時發生錯誤，請稍後重試。",
	animeRetry: "重試",
	animeEmptyData: "暫無數據",
	animeEmptyDescription: "未找到相關番劇記錄。",
	animeEmptySuggestion: "請嘗試更改篩選條件或刷新頁面。",
	animeEmpty: "未配置",
	animeConfigDescription:
		"請在 siteConfig.ts 中配置 Bangumi 用戶 ID 以啟用此頁面。",
	animeYear: "年份",
	animeEpisodes: "集數",
	animeRank: "排名",
	animeUnknown: "未知",
	animeLoadFailed: "獲取失敗",
	animeRefreshNote:
		"注意：本頁使用客戶端渲染，Bangumi收藏數據更新可能有延遲，如未同步請嘗試強制刷新。",

	projects: "專案展示",
	projectsSubtitle: "我的個人專案",
	projectsTotal: "專案總數",
	projectsCompleted: "已完成",
	projectsInProgress: "進行中",
	projectsPlanned: "計劃中",
	projectsTechStack: "技術棧",
	projectsFeatured: "精選專案",
	projectsDemo: "在線演示",
	projectsSource: "源代碼",
	projectsWeb: "Web開發",
	projectsMobile: "移動應用",
	projectsDesktop: "桌面應用",
	projectsOther: "其他",

	skills: "技能清單",
	skillsSubtitle: "我的技術技能",
	skillsTotal: "技能總數",
	skillsExpert: "專家",
	skillsAdvanced: "高級",
	skillExperience: "經驗",
	skillsAdvancedTitle: "進階",
	...
	timeline: "時間線",
	timelineSubtitle: "我的職業歷程",
	timelineTotal: "事件總數",
	timelineWork: "工作經歷",
	timelineProjects: "專案經歷",
	timelineExperience: "經驗",
	timelineCurrent: "當前",
	timelinePresent: "至今",
	timelineHistory: "歷史",
	timelineEducation: "教育經歷",
	timelineProject: "專案",
	timelineAchievement: "成就",
	timelineAchievements: "成就列表",
	timelineStatistics: "統計信息",
	timelineByType: "按類型",
	timelineWorkExperience: "工作經驗",
	timelineTotalExperience: "總經驗",
	timelineYears: "年",
	timelineMonths: "月",
	timelineWorkPositions: "職位",
	timelineCurrentRole: "當前職位",
	timelineEmployed: "在職",
	timelineAvailable: "在這尋找機會",
	timelineArchive: "歸檔",
