...
export const ru: Translation = {
	anime: "Аниме",
	animeSubtitle: "Мой список аниме",
	animeTitle: "Список аниме",
	animeStatusAll: "Все",
	animeStatusDoing: "Смотрю",
	animeStatusDone: "Просмотрено",
	animeStatusWish: "В планах",
	animeStatusOnhold: "Отложено",
	animeStatusDropped: "Брошено",
	animeList: "Список аниме",
	animeLoading: "Загрузка...",
	animeLoadingDescription:
		"Получение данных из Bangumi, пожалуйста, подождите...",
	animeError: "Ошибка загрузки",
	animeErrorDescription:
		"Произошла ошибка при получении данных. Пожалуйста, попробуйте позже.",
	animeRetry: "Повторить",
	animeEmptyData: "Нет данных",
	animeEmptyDescription: "Список аниме не найден.",
	animeEmptySuggestion: "Попробуйте изменить фильтры или обновить страницу.",
	animeEmpty: "Не настроено",
	animeConfigDescription:
		"Пожалуйста, настройте Bangumi User ID в siteConfig.ts, чтобы включить эту страницу.",
	animeYear: "Год",
	animeEpisodes: "Эпизоды",
	animeRank: "Рейтинг",
	animeUnknown: "Неизвестно",
	animeLoadFailed: "Ошибка",
	animeRefreshNote:
		"Примечание: эта страница использует рендеринг на стороне клиента. Обновление данных может занять некоторое время.",

	projects: "Проекты",
	projectsSubtitle: "Мои проекты",
	projectsTotal: "Всего проектов",
	projectsCompleted: "Завершено",
	projectsInProgress: "В процессе",
	projectsPlanned: "В планах",
	projectsTechStack: "Технологии",
	projectsFeatured: "Избранные",
	projectsDemo: "Демо",
	projectsSource: "Код",
	projectsWeb: "Веб",
	projectsMobile: "Мобильные",
	projectsDesktop: "Десктоп",
	projectsOther: "Другое",

	skills: "Навыки",
	skillsSubtitle: "Мои навыки",
	skillsTotal: "Всего навыков",
	skillsExpert: "Эксперт",
	skillsAdvanced: "Продвинутый",
	skillExperience: "Опыт",
	skillsAdvancedTitle: "Продвинутый",
	skillsIntermediate: "Средний",
	skillsBeginner: "Начинающий",
	skillYears: "лет",
	skillMonths: "мес",
	skillsProjects: "Проекты",
	skillsDistribution: "Распределение",
	skillsByLevel: "По уровню",
	skillsByCategory: "По категории",
	skillsFrontend: "Frontend",
	skillsBackend: "Backend",
	skillsDatabase: "Базы данных",
	skillsTools: "Инструменты",
	skillsOther: "Другое",

	timeline: "Таймлайн",
	timelineSubtitle: "Мой путь",
	timelineTotal: "Всего событий",
	timelineWork: "Работа",
	timelineProjects: "Проекты",
	timelineExperience: "Опыт",
	timelineCurrent: "Сейчас",
	timelinePresent: "По настоящее время",
	timelineHistory: "История",
	timelineEducation: "Образование",
	timelineProject: "Проект",
	timelineAchievement: "Достижение",
	timelineAchievements: "Достижения",
	timelineStatistics: "Статистика",
	timelineByType: "По типу",
	timelineWorkExperience: "Опыт работы",
	timelineTotalExperience: "Общий опыт",
	timelineYears: "лет",
	timelineMonths: "мес",
	timelineWorkPositions: "Позиции",
	timelineCurrentRole: "Текущая позиция",
	timelineEmployed: "Работаю",
	timelineAvailable: "Ищу работу",
	timelineArchive: "Архив",
