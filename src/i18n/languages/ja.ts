...
export const ja: Translation = {
	anime: "アニメ",
	animeSubtitle: "私のアニメ視聴リスト",
	animeTitle: "アニメリスト",
	animeStatusAll: "すべて",
	animeStatusDoing: "視聴中",
	animeStatusDone: "視聴完了",
	animeStatusWish: "視聴予定",
	animeStatusOnhold: "一時中断",
	animeStatusDropped: "視聴中止",
	animeList: "アニメリスト",
	animeLoading: "読み込み中...",
	animeLoadingDescription:
		"Bangumiからデータを取得しています。お待ちください...",
	animeError: "読み込み失敗",
	animeErrorDescription:
		"データの取得中にエラーが発生しました。後でもう一度お試しください。",
	animeRetry: "再試行",
	animeEmptyData: "データなし",
	animeEmptyDescription: "アニメリストが見つかりませんでした。",
	animeEmptySuggestion: "フィルタを変更するか、ページを更新してみてください。",
	animeEmpty: "未設定",
	animeConfigDescription:
		"この機能を使用するには、siteConfig.tsでBangumiユーザーIDを設定してください。",
	animeYear: "年",
	animeEpisodes: "話数",
	animeRank: "順位",
	animeUnknown: "不明",
	animeLoadFailed: "読み込み失敗",
	animeRefreshNote:
		"注：このページはクライアントサイドレンダリングを使用しています。データの更新には時間がかかる場合があります。",

	projects: "プロジェクト",
	projectsSubtitle: "私のプロジェクト",
	projectsTotal: "プロジェクト数",
	projectsCompleted: "完了",
	projectsInProgress: "進行中",
	projectsPlanned: "計画中",
	projectsTechStack: "技術スタック",
	projectsFeatured: "注目のプロジェクト",
	projectsDemo: "デモ",
	projectsSource: "ソースコード",
	projectsWeb: "Web開発",
	projectsMobile: "モバイル",
	projectsDesktop: "デスクトップ",
	projectsOther: "その他",

	skills: "スキル",
	skillsSubtitle: "技術スキル",
	skillsTotal: "スキル数",
	skillsExpert: "エキスパート",
	skillsAdvanced: "上級",
	skillExperience: "経験",
	skillsAdvancedTitle: "上級",
	skillsIntermediate: "中級",
	skillsBeginner: "初級",
	skillYears: "年",
	skillMonths: "ヶ月",
	skillsProjects: "関連プロジェクト",
	skillsDistribution: "スキル分布",
	skillsByLevel: "レベル別",
	skillsByCategory: "カテゴリ別",
	skillsFrontend: "フロントエンド",
	skillsBackend: "バックエンド",
	skillsDatabase: "データベース",
	skillsTools: "ツール",
	skillsOther: "その他",

	timeline: "タイムライン",
	timelineSubtitle: "キャリアパス",
	timelineTotal: "イベント数",
	timelineWork: "職歴",
	timelineProjects: "プロジェクト",
	timelineExperience: "経験",
	timelineCurrent: "現在",
	timelinePresent: "現在",
	timelineHistory: "履歴",
	timelineEducation: "学歴",
	timelineProject: "プロジェクト",
	timelineAchievement: "実績",
	timelineAchievements: "実績リスト",
	timelineStatistics: "統計",
	timelineByType: "タイプ別",
	timelineWorkExperience: "実務経験",
	timelineTotalExperience: "総経験",
	timelineYears: "年",
	timelineMonths: "ヶ月",
	timelineWorkPositions: "役職",
	timelineCurrentRole: "現在の役職",
	timelineEmployed: "在職中",
	timelineAvailable: "求職中",
	timelineArchive: "アーカイブ",
